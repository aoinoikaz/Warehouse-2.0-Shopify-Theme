  ...
  var Cart = /*#__PURE__*/function () {
    ...
    _createClass(Cart, [{
      ...
      value: function _openMiniCart() {
        ...
        /*
        const miniCartObj = document.querySelector('.mini-cart');
        
        alert('test');
        if(miniCartObj.hidden == true && )
        {
          	miniCartObj.hidden = false;
        }*/
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _attachListeners() {
        ...
        this.delegateElement.on('click', '.wholesale-product-add-to-cart-btn', this._addToCart.bind(this));
      }
      /**
       * ---------------------------------------------------------------------------------------------------
      ...
      value: function _addToCart(event, target) {
        ...
        var stringified = JSON.stringify(Form.serialize(formElement));
        console.log('Serialized: ' + Form.serialize(formElement));
  ...
  var QuantityPicker = /*#__PURE__*/function () {
    ...
    _createClass(QuantityPicker, [{
      ...
      value: function _attachListeners() 
      {
        ...
        These listeners were causing minor issues with the customization
        ive made to product page. All fixed lol.
...
function CollectionAjaxAddToCart(sender)
{
  ...
  }).then(function (response) 
  {
    ...
    if (response.ok) 
    {
      const obj_sender = sender == 'top' ? collectionBtnTop : collectionBtnBottom;
      obj_sender.dispatchEvent(new CustomEvent('product:added', 
      {
        bubbles: true,
        detail:
        {
